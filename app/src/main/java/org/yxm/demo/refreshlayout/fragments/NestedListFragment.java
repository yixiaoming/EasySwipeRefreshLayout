...
import org.yxm.component.refreshlayout.NestedListView;
import org.yxm.demo.refreshlayout.R;
import org.yxm.demo.refreshlayout.adapters.CustomListAdapter;
...
public class NestedListFragment extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    View root = LayoutInflater.from(getContext())
        .inflate(R.layout.nestedlist_fragment, container, false);
    initViews(root);
    return root;
  }
